...
import { useApproveInfluencerWithdrawMutation, useInfluencerWithdrawQuery } from '@/data/influencer-withdraw';
...
const InfluencerWithdraw = () => {
  ...
  const {
    ...
    error,
    isLoading: loading,
  } = useInfluencerWithdrawQuery({ id: withdrawId as string });
  ...
  const { mutate: approveInfluencerWithdraw, isLoading: approving } =
    useApproveInfluencerWithdrawMutation();

  function handleApproveWithdraw({ status }: any) {
    approveInfluencerWithdraw({
...
InfluencerWithdraw.authenticate = {
  permissions: adminOnly,
};
InfluencerWithdraw.Layout = AdminLayout;
