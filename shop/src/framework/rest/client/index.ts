...
class Client {
  ...
  orders = {
    ...
    initiatePayment: (input: any) =>
      HttpClient.post<any>(API_ENDPOINTS.INITIATE_PAYMENT, input),
    checkStatus: (input: any) =>
      HttpClient.post<any>(API_ENDPOINTS.CHECK_STATUS, input),
